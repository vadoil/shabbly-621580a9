      ...
      <div className="grid gap-12 md:grid-cols-4">
        ...
        <div className="md:col-span-1 space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <a href="https://max.ru/join/HLzP-8QgqEXbjRPQXSF18YGGTddHfkr5RbqSbG5AbgQ" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center w-10 h-10 rounded-full border border-border hover:border-primary hover:bg-primary/10 transition-all text-xs font-bold" title="MAX">
              MAX
            </a>
          </div>
          <a href="tel:+79685605922" className="block text-sm text-muted-foreground hover:text-primary transition-colors pt-2">
            +7 968 560 5922
          </a>
        </div>
